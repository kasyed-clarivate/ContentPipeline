...
<html lang="en">
<head>
    <title>Code coverage report for lib/template.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">all files</a> / <a href="index.html">lib/</a> template.js
    </h1>
    <div class='clearfix'>
...
function getTemplatePartials() {
  ...
  var fileList = fs.readdirSync(partialDirectory).map(function(file) {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (file[0] === ".") {
