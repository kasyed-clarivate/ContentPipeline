...
@chemTableContentOra @contentCheck
Scenario: Check the Chem Tables Count are Identical between Ingest Exposure
  ...
  """
  Then I should get the difference from "Source" minus "Target" in "TableContent" csv file
  Then I should get the difference from "Target" minus "Source" in "TableContent" csv file
