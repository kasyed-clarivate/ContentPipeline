...
Scenario: Check the list of tables exists in a specific Chem domain area
  ...
  AND lower(table_name) IN ('ch_calc_properties_cax','ch_ddr_activity','ch_int_structure','ch_ddr_dcr','ch_jph_history','ch_relationship','ch_structure_deleted')
  order by table_name
  """
  ...
  AND table_name IN ('ch_calc_properties_cax','ch_ddr_activity','ch_int_structure','ch_ddr_dcr','ch_jph_history','ch_relationship','ch_structure_deleted')
  order by table_name
  """
